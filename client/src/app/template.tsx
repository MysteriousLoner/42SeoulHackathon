    ...
    <ThemeProvider theme={theme}>
      <CartContextProvider>
        <Drawer open={openLeftDrawer} onClose={toggleLeftDrawer(false)}>
          <Box sx={{ width: 250 }}>
            <List>
              <ListItemButton component={Link} href={"/42kl-food-app"}>
                <ListItemIcon>
                  <HomeIcon />
                </ListItemIcon>
                <ListItemText primary="Home" />
              </ListItemButton>
              <ListItemButton component={Link} href={"/42kl-food-app/statistics"}>
                <ListItemIcon>
                  <StatisticIcon />
                </ListItemIcon>
                <ListItemText primary="Statistics" />
              </ListItemButton>
              <ListItemButton component={Link} href={"/42kl-food-app/leaderboard"}>
                <ListItemIcon>
                  <LeaderboardIcon />
                </ListItemIcon>
                <ListItemText primary="Leaderboard" />
              </ListItemButton>
              <ListItemButton component={Link} href={"/42kl-food-app/panda_game/index.html"} target="_blank" rel="noopener noreferrer">
                <ListItemIcon>
                  <PetsIcon />
                </ListItemIcon>
